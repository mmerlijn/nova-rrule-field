<template>
    <div class="tags-input-root">
        <div class="w-full form-control form-input form-input-bordered">
            <span class="tags-input-badge tags-input-badge-pill tags-input-badge-selected-default flex items-center"
